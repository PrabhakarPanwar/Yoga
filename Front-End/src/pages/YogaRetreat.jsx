...
const WHATSAPP_LINK = "https://wa.me/918532064201?text=Hi%2C%20I%27m%20interested%20in%20booking%20the%20Yoga%20Retreat%20in%20Bengaluru.%20Please%20share%20the%20details."

// ─────────────────────────────────────────────────────────────
//  🎛️  IMAGE POSITION CONTROLS
// ─────────────────────────────────────────────────────────────
const BG_POSITIONS = {
  hero:      "50% 20%",
  about:     "50% 50%",
    ...
    <div className='w-full bg-[#f7f5f0] overflow-x-hidden font-serif'>
      ...
      <div
        ...
        style={{
          ...
          minHeight: '560px',
          maxHeight: '900px',
          backgroundImage: `url(${shubhPic[17]})`,
      ...
      <div className='max-w-6xl mx-auto px-4 sm:px-8 py-16 grid lg:grid-cols-2 gap-10 items-center' id='expectation'>
        <FadeIn className='order-2 lg:order-1'>
          ...
          <h2 className='text-3xl sm:text-4xl font-bold text-stone-800 mb-6 leading-snug'>
            An Immersive Yogic<br />Experience in Bengaluru
          </h2>
          <div className='space-y-4 text-stone-600 font-sans text-sm sm:text-base leading-relaxed'>
            <p>Available year-round, the Yoga Vacation programme in Bengaluru offers the chance to immerse yourself fully in the yogic lifestyle and dive deep into the ancient teachings of India. Leave behind the stresses of daily life to rediscover the joy of mindful living in the calm, green surroundings of Kasavanahalli.</p>
        ...
        <FadeIn delay={200} className='order-1 lg:order-2'>
          <div className='relative'>
            <div
              ...
              style={{
                aspectRatio: '4/5',
                backgroundImage: `url(${shubhPic[18]})`,
                backgroundSize: 'cover',
            ...
            <div className='absolute -bottom-4 -left-4 bg-teal-800 text-white p-4 rounded-xl shadow-xl font-sans text-sm hidden sm:block'>
              <p className='font-bold text-amber-300'>📍 Kasavanahalli</p>
              <p className='text-teal-200 text-xs'>Bengaluru, Karnataka</p>
            </div>
          </div>
        </FadeIn>
      </div>
      ...
      <div className='max-w-6xl mx-auto px-4 sm:px-8 py-16' id='Accommodations'>
        ...
        <div className='grid sm:grid-cols-2 lg:grid-cols-3 gap-5'>
          {[
            { icon: "✨", title: "What to Expect", desc: "A balanced Sattvic lifestyle — early morning meditation, daily asana, and immersive silence to reset your nervous system amidst Bengaluru's greenery." },
            ...
            { icon: "🛏️", title: "Accommodations", desc: "Clean, comfortable shared or private rooms for deep rest, located within the peaceful and well-connected Kasavanahalli neighbourhood of Bengaluru." },
      ...
      <div
        ...
        style={{
          aspectRatio: '16/7',
          backgroundImage: `url(${shubhPic[19]})`,
          backgroundSize: 'cover',
      ...
      <div className='bg-stone-800 text-white py-16 px-4 sm:px-8'>
        <div className='max-w-4xl mx-auto grid sm:grid-cols-2 gap-10 items-center'>
          <FadeIn>
            ...
            <h2 className='text-2xl sm:text-3xl font-bold mb-4'>Kasavanahalli,<br />Bengaluru, Karnataka</h2>
            <p className='text-stone-300 font-sans text-sm leading-relaxed mb-6'>
              Tucked in the serene, leafy surroundings of Kasavanahalli in south-east Bengaluru — a peaceful neighbourhood away from city chaos yet easily accessible from all major areas of the city.
            </p>
            <div className='space-y-2 font-sans text-sm text-stone-300'>
              {[
                "✈️  Nearest Airport: Kempegowda International Airport (~45 min)",
                "🚆  Nearest Railway: Carmelaram / Whitefield Station",
                "🚌  Auto, cab & BMTC bus connections available",
          ...
          <FadeIn delay={200}>
            <div
              ...
              style={{
                aspectRatio: '4/3',
                backgroundImage: `url(${shubhPic[21]})`,
                backgroundSize: 'cover',
      ...
      <div className='bg-amber-50 border-t border-amber-100 py-16 px-4 text-center'>
        <FadeIn>
          ...
          <p className='text-stone-500 font-sans text-sm max-w-md mx-auto mb-8'>
            Spaces are limited. Join us in Bengaluru and begin the journey back to yourself. Reach out on WhatsApp to reserve your place today.
          </p>
          ...
          <p className='text-stone-400 font-sans text-xs mt-5'>📞 +91 85320 64201</p>
        </FadeIn>
      </div>

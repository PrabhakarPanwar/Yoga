...
const WA_BASE = "https://wa.me/918532064201?text=";
const waLink = (program = "") =>
  WA_BASE +
  encodeURIComponent(
    `Hello Shubham, I am messaging you from Shubh YogShala. I am interested in ${
...
const PROGRAMS = [
  {
    ...
    description: [
      "Personal Yoga at Shubh YogShala is the deepest, most transformative way to begin or deepen your practice. When Shubham teaches you one-on-one, there are no distractions, no generalised cues — only presence, awareness, and a practice built entirely for your body.",
      ...
      "Whether your goal is weight management, stress relief, flexibility, spiritual deepening, or simply to feel more alive in your body — Personal Yoga at Shubh YogShala delivers results that group classes simply cannot match.",
    ],
    benefits: [
  ...
  },
  {
    ...
    description: [
      "Geography is no longer a barrier to authentic yoga practice. Shubham's Online Yoga program brings the full depth of Shubh YogShala — the precision, the warmth, the awareness — into your home, your office, or wherever you are in the world.",
  ...
  },
  {
    ...
    description: [
      "The modern workplace demands peak cognitive performance from people whose nervous systems are chronically overstimulated. Corporate Yoga at Shubh YogShala addresses this at the root — not with wellness posters, but with real practice.",
      ...
      "Companies that have engaged Shubh YogShala report reduced sick days, better team morale, improved focus in meetings, and a tangibly calmer office environment.",
    ],
    benefits: [
  ...
  },
  {
    ...
    description: [
      "Something extraordinary happens when people practise yoga together. The shared breath, the collective stillness, the gentle energy that pushes you just a little further — Group Yoga at Shubh YogShala harnesses all of this, while keeping batches small enough that Shubham can give meaningful individual attention.",
    ...
    benefits: [
      ...
      "Most affordable format at Shubh YogShala",
  ...
  },
  {
    ...
    description: [
      "Therapeutic Yoga at Shubh YogShala is not standard yoga with modifications. It is a completely different approach — one where Shubham begins by understanding your condition, your medical history, and your body's specific patterns of tension, compensation, and restriction.",
  ...
  },
  {
    ...
    description: [
      "Children are natural yogis — they are flexible, present, and openly curious. Kids Yoga at Shubh YogShala nurtures these innate qualities while gently building the physical, emotional, and cognitive foundations that will serve them for life.",
...
function SEOHead({ program }) {
  useEffect(() => {
    const title = `${program.title} in Haridwar | ${program.subtitle} | Shubh YogShala`;
    ...
    setMeta("keywords", `${program.title}, yoga Haridwar, yoga classes, Shubham Pundir, Shubh YogShala, ${program.subtitle}`);
    ...
    const schema = {
      ...
      provider: {
        "@type": "LocalBusiness",
        name: "Shubh YogShala",
        telephone: "+91-8532064201",
        address: { "@type": "PostalAddress", addressLocality: "Haridwar", addressRegion: "Uttarakhand", addressCountry: "IN" },
        sameAs: [
          "https://wa.me/918532064201",
          "https://www.instagram.com/shubh.yogshala?igsh=MTM1eDQ4c2NlNHoyZg%3D%3D&utm_source=qr",
          "https://www.facebook.com/share/1DW9egtanT/?mibextid=wwXIfr",
        ],
        email: "pundirshubham487@gmail.com",
      },
      areaServed: "India",
    ...
    <div className="min-h-screen bg-[#fdf8f2]" style={{ fontFamily: "'Georgia', 'Times New Roman', serif" }}>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-end gap-10">
            <div className="flex-1 text-white">
              <div className="flex items-center gap-3 mb-4 flex-wrap">
                ...
                <span className="text-xs tracking-[0.4em] uppercase text-white/60">{active.subtitle} · Shubh YogShala</span>
              </div>
      ...
      <section className="py-24 px-6 text-center relative overflow-hidden" style={{ backgroundColor: active.color }}>
        ...
        <div className="relative">
          ...
          <p className="mt-5 text-white/40 text-xs">+91 85320 64201 · Free trial · No commitment</p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-2xl md:text-3xl font-light text-[#3b2a1a]">
              Other Programs at <span className="italic text-[#c8763a]">Shubh YogShala</span>
            </h2>
          </div>
